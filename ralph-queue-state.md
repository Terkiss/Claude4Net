...
- **Queue Status**: `active`
- **Active Card**: `K097`
- **Current Target**: K097 (Release Control Tower / Routine Scheduler v2)
...
| K097 | Release Control Tower / Routine Scheduler v2 | In Progress | Active Milestone |
...
- Done When: 신규 `K097SchedulerV2Tests`가 작성되고, 모든 tests 및 verify-release.ps1 gate가 에러 없이 성공적으로 통과함.
- Commit/Push:
